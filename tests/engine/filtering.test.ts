...
import { wordMatchesFilters, getFilteredWords, getAvailableWords } from '../../src/engine/filtering';
...
function makeWord(id: string, categories: Record<string, string[]>): NormalizedWord {
  return {
    id,
    original: 'Test',
    normalized: 'TEST',
